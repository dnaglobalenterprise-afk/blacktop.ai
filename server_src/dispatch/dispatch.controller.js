...
var DispatchController = function () {
    var _classDecorators = [(0, common_1.Controller)('dispatch')];
    ...
    var DispatchController = _classThis = /** @class */ (function () {
        ...
        DispatchController_1.prototype.ping = function () {
            return { ok: true, module: 'dispatch' };
        };
        DispatchController_1.prototype.assign = function (body) {
            if (!(body === null || body === void 0 ? void 0 : body.loadId) || !(body === null || body === void 0 ? void 0 : body.driverId) || !(body === null || body === void 0 ? void 0 : body.truckId)) {
