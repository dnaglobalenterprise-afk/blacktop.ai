...
var AssignmentsController = function () {
    var _classDecorators = [(0, common_1.Controller)('assignments')];
    ...
    var AssignmentsController = _classThis = /** @class */ (function () {
        function AssignmentsController_1(assignmentsService) {
            this.assignmentsService = (__runInitializers(this, _instanceExtraInitializers), assignmentsService);
        }
        AssignmentsController_1.prototype.create = function (dto) {
            return this.assignmentsService.create(dto);
        };
        AssignmentsController_1.prototype.findAll = function (carrierId) {
            return this.assignmentsService.findByCarrier(carrierId);
        };
        return AssignmentsController_1;
    }());
