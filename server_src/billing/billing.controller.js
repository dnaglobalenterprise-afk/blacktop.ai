...
var BillingController = function () {
    ...
    var BillingController = _classThis = /** @class */ (function () {
        ...
        BillingController_1.prototype.getInvoice = function (loadId, base, detention, lumper) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.billingService.generateInvoice(loadId, Number(base), Number(detention || 0), Number(lumper || 0))];
                });
            });
        };
    ...
    (function () {
        ...
        _getInvoice_decorators = [(0, common_1.Get)('invoice')];
