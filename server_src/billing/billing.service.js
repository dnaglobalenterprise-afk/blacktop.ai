...
var BillingService = function () {
    ...
    var BillingService = _classThis = /** @class */ (function () {
         ...
         */
        BillingService_1.prototype.generateInvoice = function (loadId_1, baseRate_1) {
            return __awaiter(this, arguments, void 0, function (loadId, baseRate, detention, lumper) {
                var load, totalInvoice;
                if (detention === void 0) { detention = 0; }
                if (lumper === void 0) { lumper = 0; }
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.load.findUnique({
                                where: { id: loadId },
                        ...
                        case 1:
                            ...
                            totalInvoice = baseRate + detention + lumper;
                            return [2 /*return*/, {
                                    invoiceNumber: "INV-".concat(load.reference),
